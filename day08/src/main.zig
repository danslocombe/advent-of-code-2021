...
const SegmentValues = struct {
    ...
    pub fn infer_remapping(self : SegmentValues) Remapping {
        ...
        for (self.digit_values) |value| {
            switch (value.get_count()) {
                2 => inferred_digits[1] = value,
                3 => inferred_digits[7] = value,
                4 => inferred_digits[4] = value,
                7 => inferred_digits[8] = value,
                else => {},
            }
        }

        // Find all with 6 segments.
